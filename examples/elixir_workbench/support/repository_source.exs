defmodule Examples.ElixirWorkbench.RepositoryCommand do
  @moduledoc false
...
defmodule Examples.ElixirWorkbench.Repository do
  @moduledoc false

  alias Examples.ElixirWorkbench.RepositoryCommand, as: Command
