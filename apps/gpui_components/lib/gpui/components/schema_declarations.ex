defmodule GPUI.Components.Schema.Declarations do
  ...
  @components [
    ...
    %{
      ...
      attrs: [
        id: :string,
        side: {:default, {:enum, ["left", "right"]}, "left"},
        collapsed: :boolean,
        collapsible: {:default, {:enum, ["none", "icon", "offcanvas"]}, "none"}
      ],
      children: true,
      events: [],
      extension: nil,
      kind: :sidebar_component,
      public_hidden_attrs: [],
      public_required_attrs: [],
      public_slots: [],
      required_events: [],
    ...
    %{
      ...
      events: [],
      extension: nil,
      kind: :sidebar_header_component,
      public_hidden_attrs: [],
      public_required_attrs: [],
      public_slots: [],
      required_events: [],
      stateful: false,
      tag: :ui_sidebar_header
    },
    %{
      __struct__: GPUI.Schema.Component,
      attrs: [id: :string, label: :required_string],
      children: true,
      events: [],
      extension: nil,
      kind: :sidebar_group_component,
      public_hidden_attrs: [],
      public_required_attrs: [],
      public_slots: [],
      required_events: [],
      stateful: false,
      tag: :ui_sidebar_group
    },
    %{
      __struct__: GPUI.Schema.Component,
      attrs: [id: :string],
    ...
    %{
      __struct__: GPUI.Schema.Component,
      attrs: [id: :string, label: :required_string, active: :boolean, disabled: :boolean],
      children: false,
      events: [click: :"phx-click"],
      extension: nil,
      kind: :sidebar_item_component,
      public_hidden_attrs: [],
      public_required_attrs: [],
      public_slots: [],
      required_events: [],
    ...
    %{
      __struct__: GPUI.Schema.Component,
      attrs: [id: :string, side: {:default, {:enum, ["left", "center", "right"]}, "center"}],
      children: true,
      events: [],
      extension: nil,
      kind: :status_item_component,
      public_hidden_attrs: [],
      public_required_attrs: [],
      public_slots: [],
      required_events: [],
