    ...
    <div class="flex grow items-start">
      <div class="flex flex-col w-[640px] gap-5 pt-8">
        ...
        <div class="flex gap-3 border-t border-slate-200 pt-5">
          <text class="text-sm text-slate-500">GPUI.Application</text><text class="text-sm text-slate-600">→</text>
          <text class="text-sm text-slate-500">GPUI.View</text><text class="text-sm text-slate-600">→</text>
