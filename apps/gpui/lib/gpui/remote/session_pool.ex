defmodule GPUI.Remote.SessionPool do
  ...
  def start_session(supervisor, opts) do
    child_spec = %{
      id: {GPUI.Remote.Session.Supervisor, System.unique_integer([:positive])},
      start: {GPUI.Remote.Session.Supervisor, :start_link, [opts]},
      restart: :temporary
    }
