defmodule GPUI.Builder do
  ...
  def child(%Element{} = element, child), do: Element.append_child(element, child)
  ...
  def justify_center(%Element{} = element), do: style(element, :justify_content, :center)
