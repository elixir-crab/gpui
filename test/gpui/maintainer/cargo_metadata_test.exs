defmodule GPUI.Maintainer.CargoMetadataTest do
  use ExUnit.Case, async: true

  alias GPUI.Maintainer.CargoMetadata
  alias GPUI.Maintainer.CargoMetadata.{Dependency, Document, Node, Package, Resolve, Target}
