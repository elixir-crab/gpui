...
defmodule GPUI.Native.LogTraceExplorerE2ETest do
  ...
  test "renders bounded log slices and supports native selection, navigation, pause, and clear" do
    ...
    window_id = Desktop.window_id!("OTP Log and Trace Explorer")
  ...
  defp await_selection(runtime) do
    ...
    after
      5_000 -> flunk("log explorer did not emit a native selection")
    end
  end
  ...
  defp await_click(runtime, event_name) do
    ...
    after
      5_000 -> flunk("log explorer did not emit #{event_name}")
    end
  end
