...
mod atoms {
    rustler::atoms! {
        ...
        header_height = "header_height", height = "height", hoverable = "hoverable", id =
        "id", indeterminate = "indeterminate", invalid_position = "invalid_position",
        ...
        = "phx-geometry-change", phx_keydown = "phx-keydown", phx_keyup = "phx-keyup",
        ...
        "placeholder", position = "position", prompt = "prompt", range = "range",
        ...
        "reveal_strategy", reverse = "reverse", revision = "revision", root = "root",
        scale = "scale", search = "search", search_placeholder = "search_placeholder",
        select = "select", selected = "selected", selected_column = "selected_column",
        selected_index = "selected_index", selection = "selection", set_size =
        "set_size", show_line_numbers = "show_line_numbers", show_whitespaces =
        "show_whitespaces", size = "size", soft_wrap = "soft_wrap", sort = "sort",
        ...
        stride = "stride", style = "style", submit = "submit", tab_size = "tab_size",
        tab_width = "tab_width", text = "text", text_align = "text_align",
        text_buffer_lock_failed = "text_buffer_lock_failed", text_overflow =
        "text_overflow", title = "title", toggle = "toggle", total_count = "total_count",
        transaction = "transaction", transaction_conflict = "transaction_conflict", tree
        = "tree", truncate = "truncate", type_atom = "type", value = "value", variant =
