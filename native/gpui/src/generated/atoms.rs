...
mod atoms {
    rustler::atoms! {
        ...
        "bordered", bottom = "bottom", bounds = "bounds", branch = "branch", buffer =
        "buffer", cancelled = "cancelled", cell_change = "cell_change", change =
        ...
        "padding_x", padding_y = "padding_y", parent_id = "parent_id", phx_bounds_change
