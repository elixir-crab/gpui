...
mod atoms {
    rustler::atoms! {
        ...
        "header_height", height = "height", hoverable = "hoverable", id = "id",
        indeterminate = "indeterminate", item_height = "item_height", justify_content =
        ...
        sort_direction = "sort_direction", sortable = "sortable", status = "status", step
        = "step", stride = "stride", style = "style", submit = "submit", tab_width =
