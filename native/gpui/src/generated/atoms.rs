...
mod atoms {
    rustler::atoms! {
        ...
        accessibility_description = "accessibility_description", accessibility_expanded =
        "accessibility_expanded", accessibility_label = "accessibility_label",
        accessibility_orientation = "accessibility_orientation", accessibility_role =
        "accessibility_role", accessibility_selected = "accessibility_selected",
        accessibility_value = "accessibility_value", align = "align", align_items =
        "align_items", anchor = "anchor", appearance = "appearance", attrs = "attrs",
        background = "background", block_projections = "block_projections", blur =
        "blur", border_color = "border_color", border_radius = "border_radius",
        ...
        "first", fit = "fit", flex = "flex", flex_basis = "flex_basis", flex_direction =
        "flex_direction", flex_grow = "flex_grow", flex_shrink = "flex_shrink", flex_wrap
        = "flex_wrap", focus = "focus", focus_request = "focus_request", font_size =
        "font_size", font_weight = "font_weight", format = "format", gap = "gap",
        geometry = "geometry", geometry_ranges = "geometry_ranges", hard_tabs =
        ...
        "last", left = "left", level = "level", lifecycle = "lifecycle", light = "light",
        ...
        = "max_columns", max_height = "max_height", max_sizes = "max_sizes", max_width =
        "max_width", menu = "menu", min = "min", min_height = "min_height", min_size =
        ...
        "phx-change", phx_click = "phx-click", phx_copy = "phx-copy", phx_focus =
        "phx-focus", phx_geometry_change = "phx-geometry-change", phx_hit_test =
        ...
        reveal = "reveal", reveal_index = "reveal_index", reveal_strategy =
        "reveal_strategy", reverse = "reverse", revision = "revision", right = "right",
        root = "root", scale = "scale", scroll_request = "scroll_request", scroll_to =
        ...
        = "window_close_request", window_closed = "window_closed", window_focus =
