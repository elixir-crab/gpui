...
mod atoms {
    rustler::atoms! {
        ...
        "geometry", hard_tabs = "hard_tabs", header_height = "header_height", height =
        "height", hoverable = "hoverable", id = "id", indeterminate = "indeterminate",
        ...
        "phx-click", phx_copy = "phx-copy", phx_geometry_change = "phx-geometry-change",
