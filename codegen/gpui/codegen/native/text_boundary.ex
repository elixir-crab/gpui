defmodule GPUI.Codegen.Native.TextBoundary do
  ...
  @spec text_buffer_new(String.t(), R.u64(), R.vec(TextSelection.t())) ::
          R.nif_result(term())
  ...
  @nif schedule: :dirty_cpu
  @spec text_buffer_snapshot(R.resource(TextBufferResource.t())) :: R.nif_result(term())
  defnif(text_buffer_snapshot(buffer), do: text_buffer_snapshot_impl(nif_env(), buffer))

  @nif schedule: :dirty_cpu
  @spec text_buffer_transact(
          R.resource(TextBufferResource.t()),
          TextTransaction.t()
        ) :: R.nif_result(term())
  ...
  @nif schedule: :dirty_cpu
  @spec text_buffer_undo(R.resource(TextBufferResource.t()), R.u64()) ::
          R.nif_result(term())
  ...
  @nif schedule: :dirty_cpu
  @spec text_buffer_redo(R.resource(TextBufferResource.t()), R.u64()) ::
          R.nif_result(term())
