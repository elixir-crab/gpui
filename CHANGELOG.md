...
- Added schema-driven public component attribute and event validation, clearer stable-ID errors, corrected schema option types, and expanded common-builder documentation.
